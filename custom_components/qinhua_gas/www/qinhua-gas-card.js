...
customElements.define('qinhua-gas-editor', QinhuaGasEditor);

class QinhuaGasCard extends LitElement {
  static getConfigElement() {
    return document.createElement("qinhua-gas-editor");
  }
...
customElements.define('qinhua-gas-card', QinhuaGasCard);

window.customCards = window.customCards || [];
window.customCards.push(
  {
    type: 'qinhua-gas-card',
    name: '秦华燃气卡片',
